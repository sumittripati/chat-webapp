...
//           </div>
//           {/* Sample User */}
//           <div className="px-4 py-2 hover:bg-gray-100 flex items-center gap-3 cursor-pointer">
...
//             <div className="flex-1">
//               <p className="font-medium text-sm">Anderson-vbn</p>
//               <p className="text-xs text-gray-500 truncate">cvbj ghjk</p>
//             </div>
//             <span className="text-xs text-gray-400">12m</span>
//           </div>

//           <div className="px-4 py-2 flex hover:bg-gray-100 items-center gap-3 cursor-pointer">
//             <img src="./userthree.png" alt="avatar" className="w-10 h-10 rounded-full"/>
//             <div className="flex-1">
//               <p className="font-medium text-sm">ftgyhu hjkjhb</p>
//               <p className="text-xs text-gray-500 truncate">hbkjed skn</p>
//             </div>
