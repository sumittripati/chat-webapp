  ...
  return (
     <div className="min-h-screen flex items-center justify-center px-4">
      <div className=" w-full max-w-md rounded-lg p-8 space-y-6">
        ...
        {/* Form Fields */}
        <div className="space-y-4 bg-white shadow-md p-3 rounded-lg">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <input type="password" placeholder="********" name='confirmPassword' value={formData.confirmPassword} onChange={Submitform} className="w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-blue-100"/>
            </div>
          
            <button className="w-full bg-blue-600 text-white font-semibold py-2 rounded-md hover:bg-blue-700 transition duration-200 cursor-pointer">Sign Up</button>
          </form>
          {/* Divider */}
