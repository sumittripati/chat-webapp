...
//                     <div className="flex flex-col gap-1.5 w-full border-1 border-gray-200 rounded-md p-4 h-123">
//                       <div className='flex justify-center'><img src="./admin-image.png" alt="profile-pic"/></div>
//                       <div className='font-bold text-xl'>Sumit Tripathi</div>
//                       <p >~Anderson~</p>
...
//                         <button onClick={() => alert('Logging out...')}  className="mt-4 py-2 bg-blue-100 text-blue-600 rounded  hover:bg-blue-200 w-30 font-bold cursor-pointer">Block</button>
//                         <button onClick={() => alert('Logging out...')}  className="mt-4 py-2 bg-gray-200 rounded  hover:bg-blue-200 w-35 font-bold cursor-pointer">Report Contact</button>
//                       </div> 
//                     </div>
//                 </div>
//               </div>
